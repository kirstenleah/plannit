...
function Country({ country }) {
  ...
  const onClick = () => setShowFiltered(true);
    ...
    <div>
      ...
      <div className="post-container">
        <div className="post-card">
          <h2 className="post-user-name" /*{user.username} will go between carrots*/>Lucy</h2>
          <img
          ...
          />
          <p /*{post.content} will go between carrots*/>
            This will interpolate post content and will say something like We started with a tour and tasting around a couple of local
            markets (I didn't see a single other tourist), and then took a relaxing little riverboat ride to her restaurant right on the
            water. A quick welcome snack and drink later and it was time to get to cooking...I'm sure there's a set plan for the day if you
            don't have any special requests but once I mentioned my favorite Thai dish it was added to my curriculum. What followed was a
          ...
          {/* {post.image} will go here in img tag */}
        </div>
        <div className="post-card">
